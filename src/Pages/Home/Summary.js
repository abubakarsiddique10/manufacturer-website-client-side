    ...
    return (
        <section className="bg-gray-100 py-20">
            <div className="container">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-4 md:grid-cols-2 px-5 py-4 md:gap-y-5 justify-center lg:gap-10 mt-5">
                    ...
                    <div class="p-5 text-center">
                        ...
                        <h2 class="font-bold text-5xl">20k+</h2>
                    ...
                    <div class="p-5 text-center">
                        ...
                        <h2 class="font-bold text-5xl">800+</h2>
